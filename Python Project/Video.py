###  
# This is the main program, it has a gui to open two video via file selector, to play them 
# after hitting play and to load a video from a webcam inside the gui.
###
